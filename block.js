...
addBlock('audio_url_play','오디오 URL 재생하기 %1',{
...
addBlock('audio_url_stop','오디오 URL 멈추기',{
    color:EntryStatic.colorSet.block.default.SOUND,
    outerline:EntryStatic.colorSet.block.darken.SOUND
},{
    params:[],
...
addBlock('audio_url_pause','오디오 URL 일시정지',{
    color:EntryStatic.colorSet.block.default.SOUND,
    outerline:EntryStatic.colorSet.block.darken.SOUND
},{
    params:[],
...
addBlock('audio_url_is_playing','오디오 URL 재생 중인가?',{
    color:EntryStatic.colorSet.block.default.SOUND,
    outerline:EntryStatic.colorSet.block.darken.SOUND
},{
    params:[],
    ...
    return urlAudio&&!urlAudio.paused;
},'basic_boolean_field');
